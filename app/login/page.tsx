                    ...
                    <div className="relative flex w-full max-w-md flex-col items-center gap-8 rounded-2xl border border-border bg-card/80 p-10 backdrop-blur-xl">
                        ...
                        <div className="flex flex-col items-center gap-3">
                            <h1 className="font-heading text-3xl font-bold text-foreground">
                                <TextAnimate type="blurInUp" by="character" delay={0.1} duration={0.3}>
                                    Campora
                                </TextAnimate>
                            </h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center gap-2 text-center">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Sign in with your <strong>@dau.ac.in</strong> Google account to post
                                items, report lost possessions, and connect with your campus community.
                            </p>
                        </div>
                        ...
                        <div className="flex items-start gap-2 rounded-lg bg-accent/50 p-3">
                            ...
                            <p className="text-xs leading-relaxed text-muted-foreground">
                                Only <strong>@dau.ac.in</strong> Google accounts are allowed. This
                                ensures a safe, campus-only community. Your data is never shared.
                            </p>
                        </div>

                        <BorderBeam size={250} duration={12} colorFrom="#7c3aed" colorTo="#c084fc" />
                    </div>
                </BlurFade>
            </main>
